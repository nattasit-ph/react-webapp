...

        {
          <div className={`${isOpen ? 'sm:hidden block': 'sm:hidden hidden'}`} id="mobile-menu">
            <div className="px-2 pt-2 pb-3 space-y-1">
              ...
              <NavLink to="/teams" className="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">
                Teams
              </NavLink>
              <NavLink to="/projects" className="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">
                Projects
              </NavLink>
              <button type="button" className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 inline-flex rounded-md text-sm font-medium" aria-expanded="false" onClick={() => {setIsActive(!isActive)}}>
                  <span>More</span>
